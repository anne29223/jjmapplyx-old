...
export const JOB_BOARD_CONFIGS = {
  snagajob: {
    name: 'Snagajob',
  ...
  jobstack: {
    name: 'JobStack',
    baseUrl: 'https://jobstack.com/jobs',
    params: {
      search: 'hourly work',
      location: 'remote'
    },
  ...
  swipejobs: {
    name: 'SwipeJobs',
    baseUrl: 'https://swipejobs.com/jobs',
    params: {
      search: 'hourly work',
      location: 'remote'
    },
